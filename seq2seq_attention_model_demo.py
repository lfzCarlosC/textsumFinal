...
class Seq2SeqAttentionModel(object):
  ...
  def _add_placeholders(self):
   ...
   # print self._abstracts
   # print self._targets
   # print self._article_lens
   # print self._abstract_lens
   # print self._loss_weights
  def _add_seq2seq(self):
    ...
    with tf.variable_scope('seq2seq'):
      ...
      with tf.variable_scope('embedding'), tf.device('/gpu:0'):
        ...
        #print emb_encoder_inputs # 128*4
        #print "=========emb_decoder_inputs"
        #print emb_decoder_inputs # 128*4
